...
class ArgumentAfterBlockNewline(AbstractCustomFormatter):
    def format_lines(self, lines):
        ...
        for line in lines:
            ...
            final_adrift_param = preceding_line_block_literal_param and ":" in stripped_line and "[" not in stripped_line and stripped_line.endswith(";") and indentation_len > 8
